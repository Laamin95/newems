<template>
  <div class="p-6 space-y-10 text-left">
      ...
      <div class="max-w-md space-y-4">
        ...
        >
          ...
          <template #selected="{ selected }">
            <div class="flex items-center gap-2">
              <span :class="['w-2 h-2 rounded-full', selected.color]"></span>
              {{ selected.label }}
            </div>
          </template>
        </Select>
    ...
    <section class="space-y-4">
      ...
      <div class="max-w-md space-y-4">
        <Select v-model="sizeXs" :options="basicOptions" size="xs" label="Extra Small" placeholder="XS size" />
        <Select v-model="sizeSm" :options="basicOptions" size="sm" label="Small" placeholder="SM size" />
        <Select v-model="sizeMd" :options="basicOptions" size="md" label="Medium (Default)" placeholder="MD size" />
        <Select v-model="sizeLg" :options="basicOptions" size="lg" label="Large" placeholder="LG size" />
        <Select v-model="sizeXl" :options="basicOptions" size="xl" label="Extra Large" placeholder="XL size" />
      </div>
    </section>
    ...
    <section class="space-y-4">
      ...
      <div class="max-w-md space-y-4">
        ...
        <Select 
          ...
          multiple
          :max-selections="3"
          hint="You can select maximum 3 items"
        />
      </div>
      <div class="text-sm ui-text-secondary">
        Multiple: {{ multipleValue }}, Chips: {{ multipleChips }}, Limited: {{ multipleLimited }}
      </div>
    </section>

    <!-- Grouped Options -->
    <section class="space-y-4">
      <h2 class="text-lg font-semibold ui-text-primary border-b border-color-3 pb-2">Grouped Options</h2>
      <div class="max-w-md space-y-4">
        <Select 
    ...
    <section class="space-y-4">
      ...
      <div class="max-w-md space-y-4">
        <Select v-model="roundedNone" :options="basicOptions" label="None" placeholder="No rounding" rounded="none" />
        <Select v-model="roundedSm" :options="basicOptions" label="Small" placeholder="Small rounding" rounded="sm" />
        <Select v-model="roundedMd" :options="basicOptions" label="Medium" placeholder="Medium rounding" rounded="md" />
        <Select v-model="roundedLg" :options="basicOptions" label="Large" placeholder="Large rounding" rounded="lg" />
        <Select v-model="roundedFull" :options="basicOptions" label="Full" placeholder="Full rounding" rounded="full" />
      </div>
    </section>
    ...
    <section class="space-y-4">
      ...
      <div class="max-w-md space-y-4">
        ...
        >
          <template #option="{ option }">
            <div class="flex items-center gap-3 py-1">
              ...
              <div>
                <div class="font-medium ui-text-primary">{{ option.name }}</div>
                <div class="text-xs ui-text-secondary">{{ option.role }}</div>
              </div>
            </div>
          </template>
          <template #selected="{ selected }">
            <div class="flex items-center gap-2">
              <div class="w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center text-primary font-semibold text-xs">
        ...
        <Select 
          ...
          :options="countryOptionsWithFlag" 
          label="Select Country"
        ...
        >
          <template #option="{ option }">
            <div class="flex items-center gap-2">
              ...
              <span class="text-xs ui-text-secondary">({{ option.code }})</span>
            </div>
          </template>
          <template #selected="{ selected }">
            <div class="flex items-center gap-2">
        ...
        >
          <template #option="{ option }">
            <div class="flex items-center gap-2">
              <span :class="['w-4 h-4 rounded', option.class]"></span>
              <span>{{ option.name }}</span>
            </div>
          </template>
          <template #selected="{ selected }">
            <div class="flex items-center gap-2">
              <span :class="['w-4 h-4 rounded', selected.class]"></span>
              <span>{{ selected.name }}</span>
            </div>
          </template>
        </Select>
      ...
      <div class="max-w-md bg-color-2 rounded-xl border border-color-3 p-6">
        ...
        <div class="space-y-4">
          ...
          >
            <template #option="{ option }">
              <div class="flex items-center justify-between w-full">
                ...
                <span :class="['text-xs', option.inStock ? 'text-green-500' : 'text-red-500']">
          ...
          >
            <template #option="{ option }">
              <div class="flex items-center gap-2">
                <span :class="['w-5 h-5 rounded-full border border-color-3', option.class]"></span>
                <span>{{ option.name }}</span>
              </div>
            </template>
            <template #selected="{ selected }">
              <div class="flex items-center gap-2">
                <span :class="['w-4 h-4 rounded-full border border-color-3', selected.class]"></span>
                <span>{{ selected.name }}</span>
              </div>
            </template>
          </Select>
